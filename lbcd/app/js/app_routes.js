...
define(['app', 'authentication'], function(app) {
    ...
    app.config(['$routeProvider', '$locationProvider', function($routeProvider, $locationProvider) {
        ...
        $routeProvider.
            when('/lbcd/',                   { templateUrl: '/lbcd/app/views/index.html',                 label: 'Home',           resolve: {user : resolveUser() } }).
            ...
            when('/lbcd/case-studies',       { templateUrl: '/lbcd/app/views/casestudies/casestudies.html', label: 'Case Studies',   resolve: {user : resolveUser() } }).
